...
import sty from "./PlasmicButton.module.css"; // plasmic-import: pzYYlrC0vIFk/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 5OOkgaU4XIeF/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 4MsgJ7nFsq68/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mudG0)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__fUb52)}
                role={"img"}
              />
            ),
